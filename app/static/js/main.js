...
function loadstaticbike(x){
	$.getJSON('http://ec2-52-87-181-248.compute-1.amazonaws.com:8080/static', function(data, status, xhr){
		for (var i = 0; i < data.length; i++ ) {
...
function findLatLongStart(x){
	...
	jQuery.ajax ({
	url: 'http://ec2-52-87-181-248.compute-1.amazonaws.com:8080/googleapi', type: "POST", data: JSON.stringify(location),
...
function lineGraphDays(id,name){
	...
	jQuery.ajax ({
	url: 'http://ec2-52-87-181-248.compute-1.amazonaws.com:8080/linegraphdays',type: "POST",data: JSON.stringify(id),dataType: "json",
...
function lineGraphHours(day){
	...
	//post ID to flask and result is graph
	jQuery.ajax ({
	url: 'http://ec2-52-87-181-248.compute-1.amazonaws.com:8080/linegraphhours', type: "POST", data: JSON.stringify([day,stationID]),
	dataType: "json", contentType: "application/json; charset=utf-8", success: function(data, status, xhr){
...
function futurePredict(){
	...
	jQuery.ajax ({
	url: 'http://ec2-52-87-181-248.compute-1.amazonaws.com:8080/predict',type: "POST",data: JSON.stringify([stationID,selectedDay,selectedHour]),dataType: "json",
	contentType: "application/json; charset=utf-8",success: function(data, status, xhr){
	...
	jQuery.ajax ({
	url: 'http://ec2-52-87-181-248.compute-1.amazonaws.com:8080/futureweatherpredict',type: "POST",data: JSON.stringify([selectedDay,selectedHour]),dataType: "json",
	contentType: "application/json; charset=utf-8",success: function(data, status, xhr){
