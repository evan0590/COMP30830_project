...
#To run in shell   
#python 'insertpathdirectorywherefilesaved'\tests.py
...
class MyTest(TestCase):
    def create_app(self):
    """Create application object for testing"""
